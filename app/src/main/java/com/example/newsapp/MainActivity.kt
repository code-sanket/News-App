...
import com.example.newsapp.MySingleton.Companion.getInstance
...
class MainActivity : AppCompatActivity(), NewsItemClicked {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView.layoutManager = LinearLayoutManager(this) // layout manager decides style of display//
        fetchData()
